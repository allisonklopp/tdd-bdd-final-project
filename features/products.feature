...
Scenario: Update a Product
    ...
    When I change "Description" to "A green tophat"
    ...
    And I press the "Retrieve" button
    Then I should see the message "Success"
    And I should see "A green tophat" in the "Description" field

    When I press the "Clear" button
    And I press the "Search" button
    Then I should see the message "Success"
    And I should see "A green tophat" in the results
...
Scenario: Search for Products by Category
    ...
    And I should see "Hat" in the results
    And I should see "Shoes" in the results
    But I should not see "Big Mac" in the results
